...
from .ag_former_head import AGFormerHead
from .pg_former_head import PGFormerHead
...
__all__ = ['BITHead', 'Changer', 'IdentityHead', 'DSIdentityHead', 'TinyHead',
           ...
           'BAN_MLPDecoder', 'BAN_BITHead', 'MLPSegHead', 'DS_FPNHead', 'AGFormerHead', 'PGFormerHead']
